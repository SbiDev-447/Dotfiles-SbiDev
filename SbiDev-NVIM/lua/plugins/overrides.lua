...
return {
  ...
  -- 2. Evitar que se usen como formateadores
  {
    "stevearc/conform.nvim",
    opts = {
      formatters = {
        -- Deshabilitar markdown-toc como formateador
        ["markdown-toc"] = {
          enabled = false,
        },
        -- Deshabilitar markdownlint como formateador
        ["markdownlint"] = {
          enabled = false,
        },
      },
      formatters_by_ft = {
        markdown = {
          -- Solo usar marksman para formato (opcional)
          -- "marksman",
        },
      },
    },
